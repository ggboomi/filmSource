...
public class MailConnect{
	...
	public static boolean sendQQmail(String from_email,String pwd,String str,String code,String name){
		...
		try {
			...
			//邮件标题
			message.setSubject("GGBOOM资源网注册验证码");
			...
			String content="<span style=\"font-size:16px;font-weight:blod;font-family:'微软雅黑'\">尊敬的 "+name+" ，您好：</span><br /><br />" +
					...
					"欢迎注册GGBOOM，您本次的注册验证码为 "+code+" 本验证码2分钟内有效，请尽快完成注册。期待您的加入！</span><br/><br /><span style=\"font-size:14px;font-family:'微软雅黑';float:right;\">"
							+ "GGBOOM科技有限公司技术部</span><br/><span style=\"font-size:14px;font-family:'微软雅黑';float:right;padding-right:10px;\">"+sdf.format(new Date())+"</span></div>";
