...
$(function(){
	...
	$.post("../findDetail",{_id:fid},function(data){
		...
		if(type=="5"){
		    ...
		    str+='<div class="pi"><div class="authi"><a href="space-uid-10234.html" target="_blank" class="xw1"">'+uf.uname+'</a>';
		    ...
		    str+='<div class="avatar" onmouseover="#"><a href="space-uid-10234.html" class="avtm" target="_blank"><img src="../../'+uf.photo+'" /></a></div>';
		    ...
		    str+='<em id="authorposton328068">发表于：'+data.pdate+'</em><span class="pipe">|</span><a href="#" rel="nofollow">只看该作者</a>';
		    ...
		    str+='<br />'+data.pcontent+'</td></tr></table></div>';
